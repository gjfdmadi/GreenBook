...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="product" class="semiProject.uploadProduct.UploadProductBean"></jsp:useBean>
...
<body>
	<%
		...
		UploadProductDBBean updb = UploadProductDBBean.getInstance();
		int re = updb.insertUploadProduct(product);
		
		if(re == 1){
			response.sendRedirect("productAllList.jsp");
		}else{
