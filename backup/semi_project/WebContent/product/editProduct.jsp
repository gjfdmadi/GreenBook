...
<body>
	<center>
		<form name="up_prodc" method="post"
			 action="admin_main.jsp?page=../product/eidtProduct_ok.jsp&product_number=<%=product_number %>&pageNum=<%=pageNum%>">
			<table>
				...
				<tr>
					<td>
						...
						onclick="location.href='productList.jsp?product_number=<%=product_number %>&pageNum=<%= pageNum %>">-->
						<input type="button" value="등록한 상품 목록" 
								onclick="location.href='admin_main.jsp?page=../product/productList.jsp&product_number=<%=product_number%>&pageNum=<%= pageNum %>'">
					</td>
				</tr>
			</table>
		</form>
