		...
		%>
				<tr>
					...
					<td width="200" height="100">
						<img src="<%=path %>\<%=stored_file_name%>" style="padding-right: 30px;"><%=product_name %>
					</td>
					<td>
						<%=product_price %>원
					</td>
					...
					<input type="button" value="수정" 
							onclick="location.href='admin_main.jsp?page=../product/editProduct.jsp&product_number=<%=product_number%>&pageNum=<%= pageNum %>'">
					</td>
					<td align="center">
						<input type="button" value="삭제" 
								onclick="location.href='admin_main.jsp?page=../product/deleteProduct_ok.jsp&product_number=<%=product_number%>&pageNum=<%= pageNum %>'">
					</td>
				</tr>
		<%
			}
