 ...
 * Generated at: 2022-09-20 08:43:37 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	request.setCharacterEncoding("UTF-8");
      ...
      out.write("	");
			...
			if(re == 1){
				response.sendRedirect("admin_main.jsp?page="+"../product/productList.jsp&pageNum="+"pageNum");
			}else{
				response.sendRedirect("admin_main.jsp?page="+"../product/productReg.jsp&pageNum="+"pageNum");
			}
