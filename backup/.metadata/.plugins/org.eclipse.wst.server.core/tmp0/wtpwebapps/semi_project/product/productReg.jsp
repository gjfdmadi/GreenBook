...
<body>
	<div class="container">
		<center>
			<table>
				<form name="up_prodc" 
					action="admin_main.jsp?page=../product/productReg_ok.jsp&product_number=<%=product_number %>&pageNum=<%=pageNum%>" 
					...
					<tr>
						<td>
							...
							onclick="location.href='admin_main.jsp?page=../product/product.List.jsp&product_number=<%=product_number %>&pageNum=<%=pageNum%>'">
						</td>
					</tr>
				</form>
			</table>
