    ...
    <div id="nav_left">
        ...
        <div class="tab">
            ...
            <div class="product_sub">
                <a href="?page=../product/productReg.jsp">상품 정보 등록</a>
                <!--  <a href="?page=../Upload_Product/myUploadProduct_List.jsp">상품 정보 조회</a>-->
                <a href="?page=../product/productList.jsp">상품 정보 조회</a>
            </div>
        </div>
        <div class="tab">
