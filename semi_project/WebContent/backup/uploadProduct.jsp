...
<body>
	<div class="container">
		<center>
			<table>
				<form name="up_prodc" action="uploadProduct_ok.jsp?product_number=<%=product_number %>&pageNum=<%=pageNum%>" method="post" enctype="multipart/form-data">
					...
					<tr>
						<td>
							...
							onclick="location.href='myUploadProduct_List.jsp?product_number=<%=product_number %>&pageNum=<%=pageNum%>'">
						</td>
					</tr>
				</form>
			</table>
