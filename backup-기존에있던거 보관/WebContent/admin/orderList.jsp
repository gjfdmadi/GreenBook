...
<html lang="ko">
  ...
  <body class="vertical  dark  ">
					...
					<td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="adminIndex.jsp?pages=orderEdit&o_dNum=<%= o_dNum%>&pageNum=<%= pageNum %>">수정</a>
                        </div>
                      </div>
	...
	%>
		...
		%>
                  	  <a class="page-link" href="adminIndex.jsp?pages=orderList&pageNum=<%= startPage-pageBlock %>">이전</a>
        <%
			}
		%>
                  </li>
		...
		%>
				<a class="page-link" href="adminIndex.jsp?pages=orderList&pageNum=<%= i %>"><%= i %></a>
		<%	
				}
			}
		%>
		...
		%>
				<a class="page-link" href="adminIndex.jsp?pages=orderList&pageNum=<%= startPage+pageBlock %>">다음</a>
		<%
			}
		%>          
                  </li>
