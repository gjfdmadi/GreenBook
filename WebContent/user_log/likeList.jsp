                ...
                <div class="card border-0 bg-transparent">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      ...
                      <span class="badge badge-pill badge-light text-muted">가격 : </span><span><%= product_price %>원</span><br>
                      <span class="badge badge-pill badge-light text-muted">조회수 : </span><span>몰라</span>
                    </p>
                  </div>
                </div> <!-- .card -->
                <%} %>
