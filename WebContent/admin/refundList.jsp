...
<html lang="ko">
  ...
  <body class="vertical  dark  ">
	...
	%>
		...
		%>
                  	  <a class="page-link" href="adminIndex.jsp?pages=refundList&pageNum=<%= startPage-pageBlock %>">이전</a>
        <%
			}
		%>
                  </li>
		...
		%>
				<a class="page-link" href="adminIndex.jsp?pages=refundList&pageNum=<%= i %>"><%= i %></a>
		<%	
				}
			}
		%>
		...
		%>
				<a class="page-link" href="adminIndex.jsp?pages=refundList&pageNum=<%= startPage+pageBlock %>">다음</a>
		<%
			}
		%>          
                  </li>
